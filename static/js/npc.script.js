...
async function loadCommentSection(e, comment_type_id=''){
    ...
    elm.innerHTML = '<span id="close_online_comment_view" onclick="closeCommentSection(this)">x</span><object data="'+ url + '?req_from=' + __cur_location.host + '&path=' + __cur_location.pathname + (comment_type_id?'&type_id=' + comment_type_id:'') +'" width="100%" height="450" />';    
