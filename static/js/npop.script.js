...
async function loadOpinionPoll(e, view_type=''){
     ...
     * Call for data
     */
    elm.innerHTML = '<span id="close_online_poll_view" onclick="closeOpinionPoll(this)">x</span><iframe src="'+ url + '?req_from=' + __cur_location.host +'" frameborder=0 allowtransparency=yes scrolling=no width="100%" height="500" />';
...
elm.innerHTML = '<div id="widget_polling_icon" title="Polling" onclick="loadOpinionPoll(this)"><img id="poll_widget_icon" src="'+ __service_provider_host +'/poll-icon.gif" /></div>';
