    ...
    <div class="content_header_block">
        <div class="row">
            ...
            <div class="col-sm-6 justify-content-end">
                ...
                <template v-else-if="(!hide_add_btn && $parent.$parent.role_access.create) || $parent.$parent.role_access.create">
...
export default {
    ...
    props: ['title','total_rows','add_button_hide'],
    data(){
        return {
            cur_path: this.$route.path,
            action_btn_offset: '',
            hide_add_btn: this.add_button_hide?this.add_button_hide:false
        }
    },
    mounted(){
