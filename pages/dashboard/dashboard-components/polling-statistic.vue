<template>
    <div class="polling_stat_block">        
        <label>Online Polling Overview</label>
        <div class="row">
            
            <div class="col-md-3">
                <div class="content_block">
                    <nuxt-link :to="{path: '/dashboard/opinion-polls?type=1'}">
            ...
            <div class="col-md-3">
                <div class="content_block">
                    <nuxt-link :to="{path: '/dashboard/opinion-polls?type=2'}">
            ...
            <div class="col-md-3">
                <div class="content_block">
                    <nuxt-link :to="{path: '/dashboard/opinion-polls'}">
                        ...
                        <div v-else class="total">{{ countable_data.total_participants?$parent.count_data_view(countable_data.total_participants):0 }}</div>
                        <div class="title"><small>Participants</small></div>
                    </nuxt-link>
                </div>
            </div>
...
export default {
    ...
    methods: {
        get_test: function(){
            this.$axios.get('/stat-report/opinion-poll').then( res => {
                console.log('get', res)
            }).catch(e => {
                // console.log(e)
        ...
        get_data: function(){
            ...
            this.$axios.get('/api/data-report/opinion-poll/stat-report' + (localStorage.getItem('req_from')?'?req_from=' + localStorage.getItem('req_from'):''), this.$parent.header_config).then( async (response) => {
