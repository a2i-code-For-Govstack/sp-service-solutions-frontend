            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter group title" class="form-control" v-model="formData.group_title" ref="group_title" /></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/domain-groups/edit/' + id, this.$parent.header_config).then( (response) => {
                console.log('Get Data', response.data)
                let getData = response.data;

                this.formData = {
                    group_title: getData.group_title,
        ...
        async formSubmit(){
            ...
            if(this.formData.group_title.trim()==''){
                this.$toast.error('Please enter group title', {icon: "Warning"});
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.domainGroupSubmit(submit_data);
