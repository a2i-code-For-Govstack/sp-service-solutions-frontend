            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter type title" class="form-control" v-model="formData.type_title" ref="type_title" /></div>
                    </div>
                    <div class="mb-4">
                        <label>Summary</label>
                        <div><textarea placeholder="Enter summary" class="form-control" v-model="formData.summary" /></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/pre-define-text/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.flagRptTypeSubmit(submit_data);
