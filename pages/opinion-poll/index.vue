    ...
    <div class="opinion_poll_view_block">
        ...
        <div class="content_block m-4">
            ...
            <div v-else>
                ...
                <template v-else-if="content && content.poll_title">
                    <h6 class="poll_title">
                    ...
                    <div v-if="formData.poll_option_id" class="row">
...
export default {
    ...
    async asyncData({ $axios, store, route }){
        ...
        let url = process.env.API_NONSSL_END + '/opinion-poll/' + route.query.id + (route.query.host?'?host=' + route.query.host:'')
        console.log(url)
        ...
        if(data && data.data){
            ...
            store.commit('opinion_polls_info/GET_DATA', data.data[0])
            // return { product_info: data.data }
        }
    },    
    mounted(){
    ...
    methods:{
        ...
        async load_data(){            
            this.content = this.$store.state.opinion_polls_info.get_data
        ...
        async submit_form(){
            ...
            this.formData.req_from = this.$route.query.host;
